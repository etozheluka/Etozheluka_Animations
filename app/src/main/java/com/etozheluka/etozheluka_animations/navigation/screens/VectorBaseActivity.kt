...
import com.etozheluka.etozheluka_animations.animations.vector.LottieActivity
import com.etozheluka.etozheluka_animations.animations.vector.VectorDrawableActivity
import com.etozheluka.etozheluka_animations.navigation.data.AnimationModel
import com.etozheluka.etozheluka_animations.navigation.data.VectorNavigationDataProvider
import com.etozheluka.etozheluka_animations.navigation.data.VectorNavigationDataProvider.LOTTIE_ANIMATION
import com.etozheluka.etozheluka_animations.navigation.data.VectorNavigationDataProvider.VECTOR_DRAWABLE_ANIMATION
import com.etozheluka.etozheluka_animations.ui.theme.AnimationTheme
import kotlin.reflect.KClass

class VectorBaseActivity : ComponentActivity() {
            ...
            AnimationTheme {
                Surface(
                    ...
                    LazyVerticalGrid(
                        ...
                        items(VectorNavigationDataProvider.optionsList) { item ->
                            AnimationItem(item)
                        }
                    }
                }
...
private fun Context.navigateToAnimation(it: AnimationModel) {
    when (it.option) {
        VECTOR_DRAWABLE_ANIMATION -> navigateToScreen(VectorDrawableActivity::class)
        LOTTIE_ANIMATION -> navigateToScreen(LottieActivity::class)
    }
}
